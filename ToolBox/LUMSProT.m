...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function varargout = LUMSProT(varargin)
% LUMSPROT MATLAB code for LUMSProT.fignext
%      LUMSPROT, by itself, creates a toolbarbutton_resetallfields LUMSPROT or raises the existing
%      singleton*.
%
%      H = LUMSPROT returns the handle to a toolbarbutton_resetallfields
%      LUMSPROT or the handle 
%      the existing singleton*.
%
% l%      LUMSPROT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LUMSPROT.M with the given input arguments.
%
%      LUMSPROT('Property','Value',...) creates a toolbarbutton_resetallfields LUMSPROT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before LUMSProT_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to LUMSProT_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
    ...
    'gui_OpeningFcn', @LUMSProT_OpeningFcn, ...
    'gui_OutputFcn',  @LUMSProT_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
if nargout
    [vargargout{1:nargout}] = gui_mainfcn(gui_State, varargin{:});
else
...
% --- Executes just before LUMSProT is made visible.
function LUMSProT_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = LUMSProT_OutputFcn(hObject, eventdata, handles)
% varargout  cell array for returning output args (see VARARGOUT);
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    try
        % Following function will load and clear default values on mouse click
        addpath('Default');
        startup_default_values(hObject, eventdata, handles);
    catch exception
...
% --- Executes during object creation, after setting all properties.
function PTMs_CreateFcn(hObject, eventdata, handles)
% hObject    handle to PTMs (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes during object creation, after setting all properties.
function Protein_units_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Protein_units (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes during object creation, after setting all properties.
function Directory_CreateFcn(hObject, eventdata, ~)
...
% --- Executes during object creation, after setting all properties.
function Exp_file_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Exp_file (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes during object creation, after setting all properties.
function database_select_CreateFcn(hObject, eventdata, handles)
% hObject    handle to database_select (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes during object creation, after setting all properties.
function peak_file_CreateFcn(hObject, eventdata, handles)
% hObject    handle to peak_file (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes during object creation, after setting all properties.
function Protein_mass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Protein_mass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes on button press in radiobutton_SingleSearch.
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    set (handles.edit_ProteinMass,'Enable','on');
    ...
    set(handles.text_Peaklist,'String','Peaklist File:');
...
% Hint: get(hObject,'Value') returns toggle state of radiobutton_BatchMode
   ...
   set(handles.checkbox_TunedMass,'Enable','off');
    ...
    set(handles.panel_SearchModes,'Visible','on');
    set(handles.menu_Database,'Enable','on')   
    ...
    set(handles.text_Peaklist,'String','Peaklist Folder:');
...
% --- Executes during object creation, after setting all properties.
function panel_SearchModes_CreateFcn(hObject, eventdata, handles)
% hObject    handle to panel_SearchModes (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object creation, after setting all properties.
function menu_MolecularWeightUnits_CreateFcn(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function menu_PeptideUnits_CreateFcn(hObject, eventdata, handles)
...
function edit_MolecularWeight_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function edit_MolecularWeight_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_MolecularWeight (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function edit_Peptide_Callback(hObject, eventdata, handles)
...
if((str2double(get(hObject,'String'))>=0)&& ~isempty(str2double(get(hObject,'String'))))
 ...
 %returns contents of Tol_Peptide_field as a double
% --- Executes during object creation, after setting all properties.

function edit_Peptide_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peptide (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes during object creation, after setting all properties.
function listbox_Modifications_CreateFcn(hObject, eventdata, handles)
...
% handles    empty - handles not created until after all CreateFcns called
   ...
   % setappdata(handles.figure_LUMSProT,'Fixed_Modifications', get(hObject,'String'));

function edit_ProteinMass_Callback(hObject, eventdata, handles)
...
if((str2double(get(hObject,'String'))>=0)&& ~isempty(str2double(get(hObject,'String'))))
     setappdata(0,'Experimental_Protein_Mass',get(hObject,'String'))
else
    errordlg('Invalid Protein Mass!','Invalid Input!','modal');
...
% --- Executes during object creation, after setting all properties.
function edit_ProteinMass_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProteinMass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes during object creation, after setting all properties.
function edit_Database_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Database (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if(Database_Directory == 0)
        Database_Directory = get(handles.edit_Database,'String');
        set(handles.edit_Database,'String',Database_Directory);
         set(handles.menu_Database,'Enable','on');
    else
        set(handles.edit_Database,'String',Database_Directory);
        set(handles.edit_Database,'ForegroundColor',[0 0 0]);
    end
    %TooltipString
    Database_Tooltip = get(handles.edit_Database,'String');
    set(handles.edit_Database,'TooltipString', Database_Tooltip);
...
% --- Executes during object creation, after setting all properties.
function edit_Peaklist_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peaklist (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
        set(hObject,'BackgroundColor','white');
...
% --- Executes on button press in pushbutton_Peaklist.
function pushbutton_Peaklist_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    try
        if(get(handles.radiobutton_SingleSearch,'Value') == 1)
         ...
         %   setappdata(handles.figure_LUMSProT,'Peaklist_Data',Single_Search_File);
...
for num_ele= 1:numel(fns)
  rmappdata(0,fns{num_ele});
    ...
    set(handles.menu_Database,'Enable','on');
    set(handles.edit_Database,'String','Browse to the Database');
    set(handles.edit_Database,'ForegroundColor',[0.6 0.6 0.6]);
    set(handles.edit_Peaklist,'String','Browse for Experimental Data');
    set(handles.edit_Peaklist,'ForegroundColor',[0.6 0.6 0.6]);
    % clear selected mods 
    ...
    set (handles.menu_PeptideUnits,'Value',1);
    set (handles.menu_OutputFormat,'Value',1);
    % clear checkboxes
...
function Print_ClickedCallback(hObject, eventdata, handles)
    ...
    % eventdata  reserved - to be defined in a future version of MATLAB
    % handles    structure with handles and user data (see GUIDATA)
    addpath(strcat(pwd,'\ExportFigure'));
    export_fig snap.png;

 
% --- Executes on button press in checkbox_ProteinMass.
function checkbox_ProteinMass_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_ProteinMass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_ProteinMass
    setappdata(handles.figure_LUMSProT,'FilterDB_checkbox',get(hObject,'Value'));

% --- Executes on button press in checkbox_TunedMass.
function checkbox_TunedMass_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_TunedMass (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_TunedMass
    setappdata(handles.figure_LUMSProT,'TuneMW_checkbox',get(hObject,'Value'));
...
% Hints: get(hObject,'String') returns contents of edit_Results as text_ProteinMassUnit
...
% handles    empty - handles not created until after all CreateFcns called
    ...
    % --- Executes on selection change in menu_Fragmentation.
function menu_Fragmentation_Callback(hObject, eventdata, handles)
...
% --- Executes during object creation, after setting all properties.
function menu_Fragmentation_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menu_Fragmentation (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes on button press in checkbox_HandleZIon.
function checkbox_HandleZIon_Callback(hObject, eventdata, handles)
% hObject    handle to checkbox_HandleZIon (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of checkbox_HandleZIon

% --- Executes on selection change in menu_BatchFileType.
function menu_BatchFileType_Callback(hObject, eventdata, handles)
% hObject    handle to menu_BatchFileType (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    Batch_Directory = get(handles.edit_Peaklist,'String');
    Batch_Files = Filtering_Batch_File_Format(handles,Batch_Directory);
    setappdata(0,'Batch_Peaklist_Data',Batch_Files);

% --- Executes during object creation, after setting all properties.
function menu_BatchFileType_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menu_BatchFileType (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Save paramters and settings in Project_Title.parameters & Project_Title.settings files
...
% --- Save parameters in Project_title.parameters menu_File
function automatic_save_parameters_ClickedCallback(hObject, eventdata, handles,Save_Parameters_File)
    
    Output_Format_list = get(handles.menu_OutputFormat,'String');
    Output_Format_Selected = get(handles.menu_OutputFormat,'Value');
    fprintf(Save_Parameters_File,'%s%s\n','Output File Format: ',Output_Format_list);
...
function automatic_save_settings_ClickedCallback(hObject, eventdata, handles,Save_Settings_File)
    ...
    fprintf(Save_Settings_File,'%s%s\n','Database Folder :',get(handles.edit_Database,'String'));
    fprintf(Save_Settings_File,'%s%s\n','Data :',get(handles.edit_Peaklist,'String'));
...
function listbox_FixedModifications_Callback(hObject, eventdata, handles)
% hObject    handle to listbox_FixedModifications (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: contents = cellstr(get(hObject,'String')) returns listbox_FixedModifications contents as cell array
%        contents{get(hObject,'Value')} returns selected item from listbox_FixedModifications

% --- Executes during object creation, after setting all properties.
function listbox_FixedModifications_CreateFcn(hObject, eventdata, handles)
% hObject    handle to listbox_FixedModifications (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function pushbutton_AddFixedModifications_Callback(~, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if ~isempty(Modifications_List_Selected_Index) && ~isempty(Modifications_List)
        ...
        Modifications_to_Fixed_Modifications = strvcat(char(Modifications_Selected_List),char(Fixed_Modifications)); 
...
function pushbutton_DeleteFixedModifications_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if ~isempty(Fixed_Modifications_List) && ~isempty(Fixed_Modifications_List_Selected_Index)
        ...
        Fixed_Modifications_to_Modifications = strvcat(char(Fixed_Modifications_Selected),char(Modifications_List)); % Vertically concatenate the list
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % function db_selected_menu_Callback(hObject, eventdata, handles)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % hObject    handle to menu_Database (see GCBO)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % eventdata  reserved - to be defined in a future version of MATLAB
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % handles    structure with handles and user data (see GUIDATA)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %  contents = cellstr(get(hObject,'String'));% returns menu_Database contents as cell array
...
function menu_OutputFormat_Callback(hObject, eventdata, handles)
% hObject    handle to menu_OutputFormat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes during object creation, after setting all properties.
function menu_OutputFormat_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menu_OutputFormat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes during object creation, after setting all properties.
function panel_Tolerances_CreateFcn(hObject, eventdata, handles)
% hObject    handle to panel_Tolerances (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called


% --- This function browse for menu_File for loading parameters and settings files
% Instead of loading default paramters & settings.. this functions loads
% user saved files (Project_Title.parameters % Project_Title.settings)
...
% handles    structure with handles and user data (see GUIDATA)      
    try
        ...
        initialpath=pwd;
        cd(strcat(initialpath,'\Parameters'));%parameters folder is selected as working  directory   
 ...
 mod={'Phosphorylation_Y';'Phosphorylation_T';'Phosphorylation_S';'Hydroxylation_P';...
    ...
    try
        ...
        if(get(handles.radiobutton_SingleSearch,'Value') == 1) % Load Settings for SINGLE Search Mode
            Settings_File = fopen(fullfile(strcat(pwd,'\Settings\single_default.settings')));
        else % Load Settings for BATCH Search Mode
            Settings_File = fopen(fullfile(strcat(pwd,'\Settings\batch_default.settings')));
           set(handles.menu_BatchFileType,'Value',1);
        end
       %fuction call to load settings
    catch exception
        msgbox('Please Set the current path to LUMSProT(Toolbox)','Set Path','modal');
        uiwait
        cd(uigetdir());
       ...
       try
        automatic_load_settings(hObject, eventdata, handles, Settings_File); 
         ...
         errordlg('default setting file encounter unexpected error','Setting eprror!','modal');
       end

% --- Called by:
% toolbarbutton_LoadDefaultParametersSettings_ClickedCallback () (line 1055)
% toolbarbutton_LoadUserSavedParametersSettings_ClickedCallback() (line 544)
% --- Function loads DEFAULT settings when LOAD DEFAULT PARAMETERS AND SETTINGS button is clicked
function automatic_load_settings(hObject, eventdata, handles, Settings_File)
    ...
    if(handles.Load_Default_file == 1) % For loading default settings
        ...
        set (handles.edit_Database,'String',Current_Database_Path);
        set(handles.edit_Database,'TooltipString', Current_Database_Path);
        ...
        set (handles.edit_Peaklist,'String',Current_Peaklist_Path);
        set(handles.edit_Peaklist,'TooltipString', Current_Peaklist_Path);
        ...
        set (handles.edit_Database,'String',Cell_info{1}{2});
        set(handles.edit_Database,'TooltipString', Cell_info{1}{2});
        setappdata(0,'Database_Path',Cell_info{1}{2});

        set (handles.edit_Peaklist,'String',Cell_info{1}{3});
        set (handles.edit_Peaklist,'TooltipString',Cell_info{1}{3});
        if get(handles.radiobutton_SingleSearch,'Value') == 1 % For Single Search mode
 ...
 % --- Called by: toolbarbutton_LoadDefaultParametersSettings_ClickedCallback() (line 1055)
% --- Called by: toolbarbutton_LoadUserSavedParametersSettings_ClickedCallback() (line 872)
function automatic_load_parameters(hObject, eventdata, handles, Parameters_File)

    formatSpec = 'Output File Format :%s Thrash Paramters: %s Database Selected :%s Protein Mass (Da) :%s Filter DB for intact Protein Mass :%s Tune Whole Protein Molecular Weight :%s Fragmentation Type Selected :%s Molecular Weight Tolerance :%s Peptide Tolerance :%s PTM Tolerance : %s';
    [Cell_info,pos] = textscan(Parameters_File,formatSpec,'Delimiter', '\n','CollectOutput', true);
    %%--------- loading fields -------
    Output_Format_List = get (handles.menu_OutputFormat,'String');
    Output_Format_List_Size = size(Output_Format_List,1);
    for i=1:Output_Format_List_Size
        if (isequal(Output_Format_List,Cell_info{1}{1}))
            set(handles.menu_OutputFormat,'Value',i);
        end
    end
   ...
   if (~isempty(Tolerances_from_File))
       for i = 1:numel(Tolerance_Units)
           ...
           while true
               [Respective_Tol_Unit, remain] = strtok(remain, ': ');
               if isempty(Respective_Tol_Unit),  break;  end
               [x, status] = str2num(Respective_Tol_Unit); % check to see if it is a value or unit
   ...
   MW_Units_List_Size = size(MW_Units_List,1);
    ...
    menu_ProteinsOutput_Callback(handles.menu_ProteinsOutput, eventdata, handles);    
   % database selection
...
% ---
function edit_ProjectTitle_Callback(hObject, eventdata, handles)
% hObject    handle to edit_ProjectTitle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    setappdata(0,'Project_Title', get(hObject,'String'));

function edit_ProjectTitle_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProjectTitle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes during object creation, after setting all properties.
function pushbutton_Results_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_Results (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% --- Executes on button press in pushbutton_DeleteVariableModifications.
function pushbutton_DeleteVariableModifications_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if ~isempty(Variable_Modifications_List) && ~isempty(Variable_Modifications_List_Selected_Index)
        ...
        Modifications_List = get(handles.listbox_Modifications,'String'); % Get list of modifications from total modifications listbox
        Variable_Modifications_to_Modifications = strvcat(char(Variable_Modifications_Selected),char(Modifications_List)); % Vertically concatenate the list
      %  final = cellstr(final);% cell array of strings from char array
...
% --- Executes on button press in pushbutton_AddVariableModifications.
function pushbutton_AddVariableModifications_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    if ~isempty(Modifications_List_Selected_Index) && ~isempty(Modifications_List)
        ...
        % Vertical concatenation of selected modifications list to fixed modifications listbox
        Modifications_to_Variable_Modifications = strvcat(char(Modifications_Selected_List),char(Variable_Modifications)); 
...
function listbox_VariableModifications_Callback(hObject, ~, handles)
% hObject    handle to listbox_VariableModifications (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    setappdata(handles.figure_LUMSProT,'VariableModifications',get(hObject,'String'));

% --- Executes during object creation, after setting all properties.
function listbox_VariableModifications_CreateFcn(hObject, eventdata, handles)
    % hObject    handle to listbox_VariableModifications (see GCBO)
    % eventdata  reserved - to be defined in a future version of MATLAB
    % handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
    ...
    if((~isempty(get(handles.edit_ProjectTitle,'String')) && (~strcmp(get(handles.edit_ProjectTitle,'String'),'Enter the Project Title'))))
               ...
               if(isempty(Database_Path) )
                ...
                MW_Tolerance = getappdata(0,'Molecular_Weight_Tol'); % Molecular Weight tolerance
                 ...
                 Proteins_Output = getappdata(handles.figure_LUMSProT,'Proteins_Output'); % Number of proteins hit shown in output
                ...
                %SAVING RESULTS FOLDER PATH
                    if(~strcmp('Directory for Saving Results',get(handles.edit_Results,'String')))
                     ...
                     if(~strcmp('Directory for Saving Results',get(handles.edit_Parameters,'String')))
                                       Parameters = get(handles.edit_Results,'String'); % retuns path of the Results folder
                    else
                    ...
                    if get(handles.radiobutton_SingleSearch,'Value') == 1
                        ...
                        if(1000<str2num(get(handles.edit_MolecularWeight,'String')))  
                        ...
                        if(4<str2num(get(handles.edit_Peptide,'String')))
                        ...
                        if(2<str2num(get(handles.edit_PTM,'String')))
                        ...
                        % --- PST_gui
                        % PST_gui will be opened after Tuned Mass will be obtained from WholeProteinMWEstimator
            ...
            %                     if(str2num(get(handles.edit_UserHopTolerance,'String')>1))
            %     errordlg('Hop tolerance can not be greater than 1','Tolerance error');
            %    % return
            % end       
            ...
            %                     path = fullfile(strcat(CurrentWorkingDirectory,'\Parameters\'));
            ...
            %               end
                    ...
                    else% Batch Experiment Mode
                        % Exporting objects to other GUIs from BATCH search mode
                        % Progressbar for WholeProteinMWEstimator
                       ...
                       setappdata(0,'path', get(handles.edit_Peaklist,'String'));
                       setappdata(0,'initial_path',pwd);
                       initial_path= pwd;
              addpath(strcat(pwd,'\Score'));
               Final_Scoring;
                       ...
                       addpath(strcat(pwd,'\ProgressBar'));
                      ...
                      setappdata(0,'Type_file',get(handles.menu_BatchFileType,'Value'));
                       ...
                       if(getappdata(0,'P_condotion')==1)
                        msgbox('Resluts are saved in Result folder','LUMSProT','Modal');
                       end
                    end
...
appdata = get(0,'ApplicationData'); %make sure it's gone
 close(handles.figure_LUMSProT);


function edit_PTM_Callback(hObject, eventdata, handles)
...
if(isempty(get(hObject,'String')))
 ...
 % returns contents of Tol_PTM_field as a double

% --- Executes during object creation, after setting all properties.
function edit_PTM_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_PTM (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
    if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes on button press in pushbutton_ThrashParameters.
function pushbutton_ThrashParameters_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_ThrashParameters (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in pushbutton_GoThrash.
function pushbutton_GoThrash_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_GoThrash (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes during object creation, after setting all properties.
function text_Database_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_Database (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB

% --- Executes during object creation, after setting all properties.
function radiobutton_SingleSearch_CreateFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton_SingleSearch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called

% --- Executes when user attempts to close figure_LUMSProT.
function figure_LUMSProT_CloseRequestFcn(hObject, eventdata, handles)
% hObject    handle to figure_LUMSProT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    Menu_Database_List = cellstr(get(hObject,'String'));% returns db_selected_menu contents as cell array
    ...
    Selected_Database = strcat(getappdata(0,'Database_Path'),'\',Menu_Database_Selected_Value);
    setappdata(0,'Selected_Database',Selected_Database);

%%  
% --- Executes on key press with focus on checkbox_ProteinMass and none of its controls.
function checkbox_ProteinMass_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to checkbox_ProteinMass (see GCBO)
...
% --- Otherwise, executes on mouse press in 5 pixel border or over pushbutton_BatchPeaklistFolder.
function pushbutton_BatchPeaklistFolder_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_BatchPeaklistFolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hints: get(hObject,'String') returns contents of edit_Parameters as text_ProteinMassUnit
...
function edit_Parameters_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to edit_Parameters (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_Parameters.
function edit_Parameters_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_Parameters (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 
% --- Executes on key press with focus on edit_Parameters and none of its controls.
function edit_Parameters_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_Parameters (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
%	Key: name of the key that was pressed, in lower case
%	Character: character interpretation of the key(s) that was pressed
...
% --- Executes during object creation, after setting all properties.
function figure_LUMSProT_CreateFcn(hObject, eventdata, handles)
% hObject    handle to figure_LUMSProT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_ProjectTitle_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProjectTitle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
function edit_ProjectTitle_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProjectTitle (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on key press with focus on menu_OutputFormat and none of its controls.
function menu_OutputFormat_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to menu_OutputFormat (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
% Modifier: name(s) of the modifier key(s) (i.e., control, shift) pressed
% handles    structure with handles and user data (see GUIDATA)
    set(handles.menu_OutputFormat,'ForegroundColor',[0 0 0]);

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over menu_OutputFormat.
function menu_OutputFormat_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to menu_OutputFormat (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    
% --- Executes on key press with focus on edit_ProteinMass and none of its controls.
function edit_ProteinMass_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProteinMass (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on key press with focus on edit_MolecularWeight and none of its controls.
function edit_MolecularWeight_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_MolecularWeight (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on key press with focus on edit_Peptide and none of its controls.
function edit_Peptide_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peptide (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on key press with focus on edit_PTM and none of its controls.
function edit_PTM_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_PTM (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_MolecularWeight.
function edit_MolecularWeight_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_MolecularWeight (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_ProteinMass.
function edit_ProteinMass_ButtonDownFcn(hObject, eventdata, handles)
    % hObject    handle to edit_ProteinMass (see GCBO)
    % eventdata  reserved - to be defined in a future version of MATLAB
    % handles    structure with handles and user data (see GUIDATA)

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_Peptide.
function edit_Peptide_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peptide (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
  
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_PTM.
function edit_PTM_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_PTM (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA) 

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_Database.
function edit_Database_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_Database (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA) 

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_Peaklist.
function edit_Peaklist_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peaklist (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
  
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_Results.
function edit_Results_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to edit_Results (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over edit_BatchDatabase.


% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over radiobutton_SingleSearch.
function radiobutton_SingleSearch_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton_SingleSearch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on key press with focus on radiobutton_SingleSearch and none of its controls.
function radiobutton_SingleSearch_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton_SingleSearch (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes during object deletion, before destroying properties.
function radiobutton_SingleSearch_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to radiobutton_SingleSearch (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes on key press with focus on edit_Results and none of its controls.
function edit_Results_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_Results (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- If Enable == 'on', executes on mouse press in 5 pixel border.
% --- Otherwise, executes on mouse press in 5 pixel border or over pushbutton_Results.
function pushbutton_Results_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_Results (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes on key press with focus on edit_Database and none of its controls.
function edit_Database_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_Database (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on key press with focus on edit_Peaklist and none of its controls.
function edit_Peaklist_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_Peaklist (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes during object deletion, before destroying properties.
function figure_LUMSProT_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to figure_LUMSProT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    delete(hObject);

% --- Executes on selection change in menu_ProteinsOutput.
function menu_ProteinsOutput_Callback(hObject, eventdata, handles)
...
% handles    structure with handles and user data (see GUIDATA)
     ...
     setappdata(handles.figure_LUMSProT,'Proteins_Output', no_of_output);

% --- Menu_ProteinsOutput = temp
% --- Executes during object creation, after setting all properties.
function menu_ProteinsOutput_CreateFcn(hObject, eventdata, handles)
% hObject    handle to menu_ProteinsOutput (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --- Executes during object deletion, before destroying properties.
function edit_ProjectTitle_DeleteFcn(hObject, eventdata, handles)
% hObject    handle to edit_ProjectTitle (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function edit_Database_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Database (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

function edit_Peaklist_Callback(hObject, eventdata, handles)
% hObject    handle to edit_Peaklist (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on key press with focus on edit_TunedMass and none of its controls.
function edit_TunedMass_KeyPressFcn(hObject, eventdata, handles)
% hObject    handle to edit_TunedMass (see GCBO)
% eventdata  structure with the following fields (see UICONTROL)
% Key: name of the key that was pressed, in lower case
% Character: character interpretation of the key(s) that was pressed
...
% --- Executes on selection change in menu_MolecularWeightUnits.
function menu_MolecularWeightUnits_Callback(hObject, eventdata, handles)
% hObject    handle to menu_MolecularWeightUnits (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% --- Executes on selection change in menu_PeptideUnits.
function menu_PeptideUnits_Callback(hObject, eventdata, handles)
% hObject    handle to menu_PeptideUnits (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)contents{get(hObject,'Value')} returns selected item from menu_PeptideUnits


% --- Executes on selection change in listbox_Modifications.
function listbox_Modifications_Callback(hObject, eventdata, handles)
% hObject    handle to listbox_Modifications (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% Hints: contents = cellstr(get(hObject,'String')) returns listbox_Modifications contents as cell array
%        contents{get(hObject,'Value')} returns selected item from listbox_Modifications
...
% --- Executes during object creation, after setting all properties.
function text_BatchFileType_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_BatchFileType (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% --------------------------------------------------------------------
function submenu_Screenshot_Callback(hObject, eventdata, handles)
% hObject    handle to submenu_Screenshot (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    % Take screenshot of LUMSProT
    %SAVING RESULTS FOLDER PATH
    if((~isempty(get(handles.edit_ProjectTitle,'String')) && (~strcmp(get(handles.edit_ProjectTitle,'String'),'Enter the Project Title')) && ~isempty(get(handles.edit_Parameters,'String'))))
        cd ('.\Parameters');
        addpath ('..\ExportFigure');
        export_fig(handles.figure_LUMSProT);
        cd ('..');
    else
        msgbox('No Project Folder Selected or Project Title Missing');
        return;
...
% --------------------------------------------------------------------
function submenu_LoadDefaultParametersSettings_Callback(hObject, eventdata, handles)
% hObject    handle to submenu_LoadDefaultParametersSettings (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
    % Load default parameters and settings from  defualt parameters and settings file
    toolbarbutton_LoadDefaultParametersSettings_ClickedCallback(hObject, eventdata, handles);
...
% --------------------------------------------------------------------
function submenu_Print_Callback(hObject, eventdata, handles)
...
% --------------------------------------------------------------------
function submenu_Exit_Callback(hObject, eventdata, handles)
...
% Functions used to remove redundant code
% ------------------------------------
...
% Exporting objects to other GUIs from SINGLE and BATCH search mode        
function Export_Objects (handles, Peaks_File)
    try
...
function pushbutton_HandleZIon_Callback(hObject, eventdata, handles)
% hObject    handle to pushbutton_HandleZIon (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
  addpath(strcat(pwd,'\Fragments'));
    setappdata(0,'HandleIon',anb);
    rmpath(strcat(pwd,'\Fragments'));


% --- Executes during object creation, after setting all properties.
function pushbutton_HandleZIon_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_HandleZIon (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
HandleIon{1,1}=0;
...
% --- Executes during object creation, after setting all properties.
function pushbutton_Database_CreateFcn(hObject, eventdata, handles)
% hObject    handle to pushbutton_Database (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function figure_LUMSProT_WindowButtonMotionFcn(hObject, eventdata, handles)
% hObject    handle to figure_LUMSProT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
function figure_LUMSProT_WindowButtonDownFcn(hObject, eventdata, handles)
